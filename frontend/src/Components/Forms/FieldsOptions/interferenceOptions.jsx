...
export const regularizationSituation = [
  { label: "Outorgado", value: "Outorgado" },
  { label: "Não outorgável", value: "Não outorgável" },
  { label: "Em análise", value: "Em análise" },
  { label: "Uso insignificante", value: "Uso insignificante" },
  { label: "Indeferido", value: "Indeferido" },
  { label: "Inválido", value: "Inválido" },
  {
    label: "Autorizado (água subterrânea)",
    value: "Autorizado (água subterrânea)",
  },
...
export const waterBodyType = [
  ...
  { label: "Poço raso", value: "Poço raso" },
...
export const cultivationType = [
  ...
  {
    label:
      "Carcinocultura (camarões e outros crustáceosOutros (não ornamentais)",
    value:
      "Carcinocultura (camarões e outros crustáceosOutros (não ornamentais)",
  },
  { label: "Outros (não ornamentais)", value: "Outros (não ornamentais)" },
  { label: "Alginocultura", value: "Alginocultura" },
  { label: "Piscicultura Pirarucu", value: "Piscicultura Pirarucu" },
  { label: "Piscicultura Pacu", value: "Piscicultura Pacu" },
];
